                ...
                <div class="form_table">
                    ...
                    <?php
                        ...
                        if(isset($_POST['search'])){
                            ...
                            $sql = "SELECT * FROM `product` WHERE hangsx LIKE '%$noidung%'";
                            ...
                            if($noidung === ""){
                                ...
                                <!-- <div class="panel-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                                while($se_contact = mysqli_fetch_array($result)){
                                            ?>
                                
                                            <tr>
                                                <td><?php echo $se_contact["ID"] ?></td>
                                                <td><?php echo $se_contact["khuvuc"] ?></td>
                                                <td><?php echo $se_contact["tinhtrang"] ?></td>
                                                <td><img src="../User/img/uploads/<?php echo $se_contact["txtpicture"]; ?>
                                                            " style="width: 50px; height: 50px;" alt="
                                                <?php echo $se_contact["txtpicture"]; ?>"></td>
                                                <td><?php echo $se_contact["hangsx"] ?></td>
                                                <td><?php echo $se_contact["dongxe"] ?></td>
                                                <td><?php echo $se_contact["namsx"] ?></td>
                                                <td><?php echo $se_contact["phienban"] ?></td>
                                                <td><?php echo $se_contact["sokmdadi"] ?></td>
                                                <td><?php echo $se_contact["hopso"] ?></td>
                                                <td><?php echo $se_contact["dandong"] ?></td>
                                                <td><?php echo $se_contact["nhienlieu"] ?></td>
                                                <td><?php echo $se_contact["giaban"] ?></td>
                                                <td><?php echo $se_contact["tieudetin"] ?></td>
                                                <td><?php echo $se_contact["motachitiet"] ?></td>
                                                ...
                                                <td><a href="../User/dangtin update.php?echo $se_contact['ID']?>"
                                                    onclick=" return(confirm('Bạn có chắc muốn xóa')) ">
                                                <span class="glyphicon glyphicon-remove"></span></a>
                                                </td>
                                    ...
                                    <a href="List_dangtin.php">Quay Lại</a>
                                <?php   
                            }
                        }else{
                        require "search-tin.php";
                        }
                    ?>
                </div>
                <!-- END CLASS FORM -->
