                ...
                <div class="form_table">
                    ...
                    <?php
                        ...
                        if(isset($_POST['search'])){
                            ...
                            $sql = "SELECT * FROM `ni_car` WHERE username LIKE '%$noidung%'";
                            ...
                            ?>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                    // include('../User/control.php');
                                                    $getdata = new data();
                                                    // $select_all = $getdata -> se_all('ni_car');
                                                    // foreach($select_all as $se_contact){
                                                    while($se_contact = mysqli_fetch_array($result)){
                                                ?>
                                                <tr>
                                                    <td><?php echo $se_contact["ID"] ?></td>
                                                    <td><?php echo $se_contact["username"] ?></td>
                                                    <td><?php echo $se_contact["phone"] ?></td>
                                                    <td><?php echo $se_contact["khuvuc"] ?></td>
                                                    <td><?php echo $se_contact["tenxe"] ?></td>
                                                    <td><?php echo $se_contact["dateshow"] ?></td>
                                                    <td><?php echo $se_contact["note"] ?></td>
                                                    <td><a href="delete_all.php?del_car=<?php echo $se_contact['ID']?>"
                                ...
                                <a href="List Car_audit.php" style="padding-left: 10px;font-size: 18px;" >Quay Lại</a>
                            <?php   
                            }
                        }else{
                        require "Search-carAudit.php";
                        }
                    ?>
